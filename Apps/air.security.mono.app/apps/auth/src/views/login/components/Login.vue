<template>
  <div>
    ...
    <el-form ref="loginFormRef" :model="loginFormData" :rules="loginRules" size="large"
      ...
      <el-form-item prop="code">
        <div flex items-center gap-10px>
          <el-input v-model.trim="loginFormData.code" :placeholder="t('login.code')" clearable class="flex-1"
    ...
    <!-- <div flex-center gap-10px>
      ...
      <el-link type="primary" underline="never" @click="toOtherForm('inject')">
        {{ t("login.reg") }}
      </el-link>
    </div> -->
...
import { removeClientAppConfig } from "@/store/modules/client/client";
...
function toOtherForm(type: "register" | "resetPwd" | "inject") {
