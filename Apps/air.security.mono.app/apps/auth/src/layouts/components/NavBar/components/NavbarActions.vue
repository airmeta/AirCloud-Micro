...
import Fullscreen from "@root/base/components/Fullscreen/index.vue";
import SizeSelect from "@root/base/components/SizeSelect/index.vue";
import LangSelect from "@root/base/components/LangSelect/index.vue";
