...
export function convertAuthorityToTree(authoritys: authorityInfo[]): authorityTree[] {
    ...
    const baseAuthorities: authorityInfo[] = memus.filter(authority => authority.parentId === "0" || authority.parentId === "" || authority.parentId === null || authority.parentId === undefined);
