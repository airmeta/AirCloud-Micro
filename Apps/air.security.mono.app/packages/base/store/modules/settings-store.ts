import { defaultSettings } from "@root/base/base_settings";
import { SidebarColor, ThemeMode } from "@root/base/enums/settings/theme-enum";
import type { LayoutMode } from "@root/base/enums/settings/layout-enum";
import { applyTheme, generateThemeColors, toggleSidebarColor } from "@root/base/utils/theme";
import { STORAGE_KEYS } from "@root/base/constants";
...
export const useSettingsStore = defineStore("setting", () => {
  ...
  const theme = useStorage<ThemeMode>(
    STORAGE_KEYS.THEME,
    defaultSettings.theme as unknown as ThemeMode
  );
  ...
  function resetSettings(): void {
    ...
    theme.value = defaultSettings.theme as unknown as ThemeMode;
  }
