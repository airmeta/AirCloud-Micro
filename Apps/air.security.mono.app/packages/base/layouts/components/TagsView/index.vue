    ...
    >
      <div h-full flex-y-center>
        <el-tag
          ...
          "
          style="margin-right:4px;height:30px;border-bottom:none;line-height:30px;border-top-left-radius:4px;border-top-right-radius:4px;border-bottom-left-radius:0px;border-bottom-right-radius:0px;min-width:110px;letter-spacing: 0.1em;"
        >
...
import { translateRouteTitle } from "@root/base/utils/i18n";
import { usePermissionStore, useTagsViewStore } from "@root/base/store";
