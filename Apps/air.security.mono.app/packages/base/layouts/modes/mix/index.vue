<template>
  <BaseLayout>
    ...
    <div class="layout__container">
      ...
      <!-- 主内容区 -->
      <div :class="{ hasTagsView: true }" class="layout__main">
        <TagsView/>
        <AppMain />
      </div>
    </div>
...
import { useLayout, useLayoutMenu } from "@root/base/composables";
import BaseLayout from "@root/base/layouts/modes/base/index.vue";
import AppLogo from "@root/base/layouts/components/AppLogo/index.vue";
...
import TagsView from "@root/base/layouts/components/TagsView/index.vue";
import AppMain from "@root/base/layouts/components/AppMain/index.vue";
import MenuItem from "@root/base/layouts/components/Menu/components/MenuItem.vue";
import Hamburger from "@root/base/components/Hamburger/index.vue";
import variables from "../../../styles/variables.module.scss";
import { isExternal } from "@root/base/utils";
import { useAppStore, usePermissionStore } from "@root/base/store";

const route = useRoute();

// 布局相关参数
const { isShowLogo, isSidebarOpen, toggleSidebar } = useLayout();
