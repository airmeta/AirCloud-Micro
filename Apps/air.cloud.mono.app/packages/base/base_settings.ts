...
export function setDefaultSettings(settings: AppSettings) {
  defaultSettings.appId = settings.appId;
  defaultSettings.appPublicKey = settings.appPublicKey;
  defaultSettings.appName = settings.appName;
  defaultSettings.showTagsView = settings.showTagsView;
}
