...
export const STORAGE_KEYS = {
  ...
  TICKIT: `${APP_PREFIX}:auth:ticket`, // Ticket令牌
  ACCOUNT_INFO: `${APP_PREFIX}:auth:account_info`, // 账号信息
  CHOSEE_APP: `${APP_PREFIX}:auth:choose_app`, // 已选择的应用
  APP_INFO: `${APP_PREFIX}:auth:app_info`, // 应用信息
} as const;
...
export const AUTH_KEYS = {
  ...
  TICKIT: STORAGE_KEYS.TICKIT,
  ACCOUNT_INFO: STORAGE_KEYS.ACCOUNT_INFO,
  CHOSEE_APP: STORAGE_KEYS.CHOSEE_APP,
  APP_INFO: STORAGE_KEYS.APP_INFO,
} as const;
