        ...
        <el-card>
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link type="primary" underline="never" href="https://github.com/airmeta/AirCloud-Micro"
                target="_blank">
                完整记录
...
import LogAPI, { VisitStatsVO, VisitTrendVO } from "@root/base/api/system/log-api";
import { useUserStore } from "@root/base/store/modules/user/user-store";
import { formatGrowthRate } from "@root/base/utils";
...
const vesionList = ref<VersionItem[]>([
  {
    ...
    content: "初始化基础代码",
    link: "https://github.com/airmeta/AirCloud-Micro",
    tag: "里程碑",
  }
]);
