<template>
  <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
    <el-form-item label="名称" prop="label">
      <el-input v-model="form.label" maxlength="128" placeholder="字典名称" show-word-limit />
    </el-form-item>
    <el-form-item label="编码" prop="code">
      <el-input v-model="form.code" maxlength="64" placeholder="DICT_CODE" show-word-limit />
    </el-form-item>
