  ...
  <el-form ref="internalFormRef" :model="formData" :rules="rules" label-width="100px">
    ...
    >
      ...
      <el-input
        ...
        placeholder="system"
      />
      <el-input v-else v-model="formData.path" placeholder="/system/user" />
    </el-form-item>
    <el-form-item v-if="formData.type == MenuTypeEnum.MENU" prop="component">
      <template #label>
        <div class="flex-y-center">
          ...
          <el-tooltip placement="bottom" effect="light">
            <template #content>
              以@room/views作为基础路径,例如：@room/views/system/user/index.vue
            </template>
            <el-icon class="ml-1 cursor-pointer">
              <QuestionFilled />
            </el-icon>
      ...
      <el-input v-model="formData.component" placeholder="@room/views/system/user/index.vue" style="width: 95%">
